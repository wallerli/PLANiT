...
//        tasks.put(null, new Task("New Task", Size.MEDIUM, Priority.MODERATE));
    ...
    public void setupDummyObjects() {
        ...
        Tag tag0 = new Tag("Work", Color.rgb(199, 146, 234));
        Tag tag1 = new Tag("CSCI 5115", Color.rgb(246, 107, 58));
        Tag tag2 = new Tag("Spring Semester", Color.rgb(246, 107, 58));
        Tag tag3 = new Tag("Group-Work", Color.rgb(255, 203, 107));
        Tag tag4 = new Tag("When you have “free time” you can do this");
        Tag tag5 = new Tag("\uD83E\uDD73", Color.rgb(130, 170, 255));
        Tag tag6 = new Tag("MOST IMPORTANT", Color.rgb(255, 83, 112));
        addTag(tag0);
        addTag(tag1);
        addTag(tag2);
        addTag(tag3);
